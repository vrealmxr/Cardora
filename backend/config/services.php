...
return [
    ...
    */
    ...
    'dhl' => [
        ...
        'domestic_product_code' => env('DHL_API_DOMESTIC_PRODUCT_CODE', 'N'),
        'intra_eu_product_code' => env('DHL_API_INTRA_EU_PRODUCT_CODE', 'U'),
        'international_product_code' => env('DHL_API_INTERNATIONAL_PRODUCT_CODE', 'P'),
        'sender_company_name' => env('DHL_API_SENDER_COMPANY_NAME', 'VRealm P.C.'),
        'sender_city_name' => env('DHL_API_SENDER_CITY_NAME', 'AMBELOKIPI'),
        'sender_vat_number' => env('DHL_API_SENDER_VAT_NUMBER', 'EL802264482'),
        'sender_vat_country_code' => env('DHL_API_SENDER_VAT_COUNTRY_CODE', 'GR'),
