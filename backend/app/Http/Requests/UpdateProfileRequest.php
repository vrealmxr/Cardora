...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'notification_preferences.binder_alerts' => ['nullable', 'array'],
            'notification_preferences.binder_alerts.in_app' => ['nullable', 'boolean'],
            'notification_preferences.binder_alerts.email' => ['nullable', 'boolean'],
            'notification_preferences.price_alerts' => ['nullable', 'array'],
            'notification_preferences.price_alerts.in_app' => ['nullable', 'boolean'],
            'notification_preferences.price_alerts.email' => ['nullable', 'boolean'],
